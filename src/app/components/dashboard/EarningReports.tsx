...
const EarningReports = () => {
  ...
  return (
    <>
      <div
        className="rounded-lg dark:shadow-dark-md shadow-md bg-white dark:bg-darkgray p-6 relative w-full break-words">
            ...
            <div className="flex items-center justify-between py-5 border-b border-ld" key={index}>
              <div className="flex gap-3 items-center">
                ...
                <div>
                  ...
                  <p className="text-darklink text-xs flex items-center gap-1">{item.subtitle} <Icon
                    icon="material-symbols:info-outline-rounded" height={13}></Icon></p>
                </div>
              </div>
              <Badge
